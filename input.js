let host = "192.168.1.2:6688"; //地址:端口 例:192.168.2.88:6688
const $ = new Env("爱海盐抽奖"),
  ckName = "ahycj";
let envSplitor = ["#", "\n"],
  strSplitor = "&";
...
!(async () => {
  if (typeof $request !== "undefined") {
    ...
    if (!(await Envs())) return;else {
      ...
      0 && (log("【debug】 这是你的全部账号数组:\n " + ckStrArr), log("【debug】 这是你的全部账号数组:\n " + ckStr1Arr));
      for (let _0x369596 = 0; _0x369596 < ckStrArr.length; _0x369596++) {
        num = _0x369596 + 1, DoubleLog("==== 开始【第 " + num + " 个账号】====", true), ck = ckStrArr[_0x369596], ck = ckStrArr[_0x369596].split("&"), requID = RandeCode(), deviceId = requID, log("账号[" + num + "] deviceId:" + deviceId), device_token = "170" + getRandomInt(16), log("账号[" + num + "] device_token:" + device_token);
        if (checkck(ck[0])) await init();else {
          sessionId = ck[0];
        }
        await $.wait(1000), await userInfo(), ck_status == true && (await get_activityid());
      }
      await SendMsg(msg);
    }
  }
...
function checkck(_0x43ed27) {
  if (undefined.test(_0x43ed27)) return true;else {
    return false;
  }
}
function getAASkey() {
...
async function Login() {
  ...
  return new Promise(_0x2908d6 => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url ==============="), log(JSON.stringify(_0x1ff116))), axios.request(_0x1ff116).then(async function (_0x170410) {
      try {
        let _0x513d8b = _0x170410.data;
        if (0) {
          log("\n\n【debug】===============这是 返回data=============="), log(JSON.stringify(_0x170410.data));
        }
        if (_0x513d8b.code == 0) {
...
async function credential_auth(_0x2d6cf4, _0x31abbb) {
  return await RSA_Encrypt(_0x31abbb), signs = CryptoJS.SHA256("post%%/web/oauth/credential_auth?client_id=" + client_id + "&password=" + rsaCode + "&phone_number=" + _0x2d6cf4 + "%%" + requID + "%%").toString(), new Promise(_0x17bbff => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x2c5ee5)), axios.request(_0x2c5ee5).then(async function (_0x14d799) {
      try {
        0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(_0x14d799.data));
        if (_0x14d799.data.code === 0) {
          log("账号[" + num + "] 获取code成功:" + _0x14d799.data.data["authorization_code"].code), await $.wait(2000), await login(_0x14d799.data.data["authorization_code"].code);
...
async function login(_0x1f2e34) {
  ...
  return new Promise(_0x3c333b => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x3aa5d4)), axios.request(_0x3aa5d4).then(async function (_0x549cf3) {
      try {
        data = _0x549cf3.data;
        if (0) {
          log("\n\n【debug】=============== 这是 返回data ============== "), log(_0x549cf3.data);
        }
...
async function init() {
  ...
  return new Promise(_0x2df41f => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x1454c9)), axios.request(_0x1454c9).then(async function (_0x1fabb3) {
      try {
        data = _0x1fabb3.data;
...
async function mine(_0x193b3f) {
  ...
  return new Promise(_0x5cbbc6 => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x30d510)), axios.request(_0x30d510).then(async function (_0x1a4d03) {
      try {
        data = _0x1a4d03.data, 0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(_0x1a4d03.data)), data.code == 0 && (await $.wait(2000), log(data.message));
      } catch (_0x41919a) {
...
async function detail(_0x447f3a) {
  ...
  return new Promise(_0x36a5bc => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x45d0b5)), axios.request(_0x45d0b5).then(async function (_0x3a6c1c) {
      try {
        data = _0x3a6c1c.data, 0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(_0x3a6c1c.data)), data.code == 0 && (await $.wait(2000), log(data.message));
      } catch (_0x547407) {
...
async function client_ids() {
  ...
  return new Promise(_0x155d63 => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x2dd617)), axios.request(_0x2dd617).then(async function (_0x472c51) {
      try {
        data = _0x472c51.data, 0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(_0x472c51.data)), data.code == 0 && (await $.wait(2000), log(data.message));
      } catch (_0x2c7cef) {
...
async function unread() {
  ...
  return new Promise(_0x12358e => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x156b0b)), axios.request(_0x156b0b).then(async function (_0x1f962c) {
      try {
        data = _0x1f962c.data, 0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(_0x1f962c.data)), data.code == 0 && (await $.wait(2000), log(data.message));
      } catch (_0xb28755) {
...
async function auth_dt() {
  ...
  return dt = _0xa8398 + "" + Math.floor(10000000 * Math.random()), new Promise(_0x32c708 => {
    ...
    if (0) {
      log("\n【debug】=============== 这是  请求 url =============== "), log(JSON.stringify(_0x4fda88));
    }
    axios.request(_0x4fda88).then(async function (_0x2a9719) {
      try {
        data = _0x2a9719.data, 0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(JSON.stringify(_0x2a9719.data))), data.code == 0 && (api_dt = data.data.slice(32, 68), log("账号[" + num + "] " + "Access-Api-Dt:" + api_dt));
      } catch (_0x39b740) {
...
async function ac_detail311() {
  ...
  t10 = ts10(), r = randomString(32), n = randomString(6), m = getAASkey(i), d = MD5(t + r + _0x144f3c + m).toString(), signature = [t, r, _0x144f3c, d].join(";"), finalString = t + ";" + r + ";" + _0x144f3c + ";" + d, signatures = MD5("app_user_token=" + sessionId + "&appid=" + t + "&noncestr=" + n + "&phone=" + uinfo["phone_number"] + "&portrait_url=https%3A%2F%2Fimg.tmuyun.com%2Fassets%2F20220729%2F1659109373830_62e3fffdad61a42834e55af2.jpeg&timestamp=" + t10 + "&user_id=" + accountid + "&user_name=" + encodeURIComponent(uinfo["nick_name"]) + "&wx_openid=&wx_unionid=&appkey=" + i).toString();
  try {
    let _0x43b9d4 = {
...
async function activity_id311(_0x3c148d) {
  ...
  return t10 = ts10(), r = randomString(32), n = randomString(6), m = getAASkey(i), d = MD5(t + r + _0x38f490 + m).toString(), signature = [t, r, _0x38f490, d].join(";"), finalString = t + ";" + r + ";" + _0x38f490 + ";" + d, new Promise(_0x5a1029 => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(JSON.stringify(_0x2770e5))), axios.request(_0x2770e5).then(async function (_0x338a4c) {
      try {
        data = _0x338a4c.data, 0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(JSON.stringify(_0x338a4c.data))), data.code == 0 && log("账号[" + num + "] " + data.msg);
      } catch (_0xbf5082) {
...
async function auth_appuserinit() {
  ...
  t10 = ts10(), r = randomString(32), n = randomString(6), m = getAASkey(i), d = MD5(t + r + _0x4482d4 + m).toString(), signature = [t, r, _0x4482d4, d].join(";"), signatures = MD5("app_user_token=" + sessionId + "&appid=" + t + "&noncestr=" + n + "&phone=" + uinfo["phone_number"] + "&portrait_url=" + encodeURIComponent(portrait_urls) + "&timestamp=" + t10 + "&user_id=" + accountid + "&user_name=" + encodeURIComponent(uinfo["nick_name"]) + "&wx_openid=&wx_unionid=&appkey=" + i).toString();
  try {
    let _0x1da28e = {
...
async function detail_(_0x2d237e) {
  ...
  return tt = ts10(), r = randomString(32), n = randomString(6), m = getAASkey(i), d = MD5(t + r + _0x3928e4 + m).toString(), signature = [t, r, _0x3928e4, d].join(";"), new Promise(_0x52285e => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x15b96e)), axios.request(_0x15b96e).then(async function (_0x583ea6) {
      try {
        0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(_0x583ea6.data));
        data = _0x583ea6.data;
        if (data.code == 0) {
          levels_ = data.data, DoubleLog("账号[" + num + "] 有" + levels_.length + "个抽奖活动");
          ...
          if (!_0x8dea2b) {
            log("账号[" + num + "] " + "该账号没有今日缓存，尝试过滑块获取token....."), DoubleLog("账号[" + num + "] 去获取滑块"), await get_captcha();
            if (tokens && tokenid) {
              var _0x5261b9 = {};
              _0x5261b9 = {
                "phone": phone,
              ...
              fs.writeFile(strShare, _0xc9b4aa, "Utf8", _0x813a75 => {
                if (_0x813a75) {
                  console.log(_0x813a75), console.log("账号[" + num + "] 缓存文件" + strShare + "更新失败!");
          ...
          await $.wait(randomInt(1000, 5000)), await _ac_detail(), await $.wait(randomInt(3000, 6000)), await getrecord11();
...
async function level_(_0x10bc2d, _0xf93d63) {
  ...
  return t10 = ts10(), r = randomString(32), n = randomString(6), m = getAASkey(i), d = MD5(t + r + _0x34d507 + m).toString(), signature = [t, r, _0x34d507, d].join(";"), new Promise(_0x16444d => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x1921a8)), axios.request(_0x1921a8).then(async function (_0xdc8124) {
      try {
        0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(_0xdc8124.data));
        data = _0xdc8124.data;
        if (_0xdc8124.data.code == 0) {
          tasks_ = data.data, DoubleLog("账号[" + num + "] 要看" + tasks_.length + "篇文章后抽奖");
...
async function task_create(_0x2e6923, _0x5e8426, _0x5ac350) {
  requID = RandeCode(), ts = +new Date(), tt = ts10(), r = randomString(32), n = randomString(6), m = getAASkey(i), d = MD5(t + r + ts + m).toString(), signature = [t, r, ts, d].join(";");
  try {
    let _0x462892 = {
    ...
    if (_0x24f533.code == 0) log("账号[" + num + "] 开始阅读:" + _0x24f533.msg + " news_id:" + _0x5e8426), task_record_id = _0x24f533.data["task_record_id"], await $.wait(randomInt(700, 3000)), await details(_0x5e8426), await $.wait(randomInt(3000, 6000)), await reads(_0x5e8426, _0x5ac350), await $.wait(randomInt(1000, 3000)), await task_done(_0x2e6923, task_record_id, _0x5ac350);else {
      DoubleLog("账号[" + num + "] 获取id:失败 ❌ 了呢,原因:" + _0x24f533.message + "!🎉"), console.log(_0x24f533);
    }
  } catch (_0x2f7ed7) {
...
async function details(_0x1f5eac) {
  return requID = RandeCode(), ts = +new Date(), new Promise(_0x2c3408 => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x816657)), axios.request(_0x816657).then(async function (_0xc9e0ab) {
      try {
        0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(_0xc9e0ab.data)), data = _0xc9e0ab.data, _0xc9e0ab.data.code === 0 ? log("账号[" + num + "] " + data.message) : log(_0xc9e0ab.data);
      } catch (_0x49549a) {
...
async function reads(_0x53be68, _0x46b419) {
  return requID = RandeCode(), ts = +new Date(), new Promise(_0x21fe9f => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x51ff4d)), axios.request(_0x51ff4d).then(async function (_0x33ca15) {
      try {
        0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(_0x33ca15.data)), data = _0x33ca15.data, _0x33ca15.data.code === 0 ? log("账号[" + num + "] 第" + _0x46b419 + "次上传阅读时间:" + data.message) : log(_0x33ca15.data);
      } catch (_0x300889) {
...
async function _ac_lottery_count(_0x20c289) {
  return requID = RandeCode(), ts = +new Date(), tt = ts10(), r = randomString(32), n = randomString(6), m = getAASkey(i), d = MD5(t + r + ts + m).toString(), signature = [t, r, ts, d].join(";"), new Promise(_0x948555 => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x5413a7)), axios.request(_0x5413a7).then(async function (_0x451e93) {
      try {
        0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(_0x451e93.data));
        data = _0x451e93.data;
        if (data.code == 0) {
          lottery_number = data.data["show_remain"], log("账号[" + num + "] 抽奖次数:" + data.data["show_remain"]);
          if (lottery_number > 0) {
            log("账号[" + num + "] 有抽奖次数 去抽奖");
            for (let _0x29539b = 0; _0x29539b < lottery_number; _0x29539b++) {
              await $.wait(1000), await _ac_detail(), await $.wait(randomInt(3000, 6000)), await _event_sub(module_id, title);
            }
          }
        } else log(data);
      } catch (_0x3017a3) {
      ...
      try {
        ...
        if (data.code == 0) DoubleLog("账号[" + num + "] 抽奖:" + _0x55c414.data.msg + " 结果:" + _0x55c414.data.data.title);else {
          if (_0x55c414.data.code === 10000) DoubleLog("账号[" + num + "] 抽奖失败,原因:" + _0x55c414.data.msg);else {
            DoubleLog("账号[" + num + "] 抽奖失败,原因:" + _0x55c414.data.msg), console.log(_0x55c414.data);
          }
        }
      } catch (_0x14dd07) {
...
async function get_captcha() {
  ...
  return tt = ts10(), r = randomString(32), n = randomString(6), m = getAASkey(i), d = MD5(t + r + _0x1cf105 + m).toString(), signature = [t, r, _0x1cf105, d].join(";"), once = randomString(10), signature1 = "{\"once\":\"" + once + "\",\"referer\":\"https://haiyan.y-h5.iyunxh.com/module-study/pass-detail/pass-detail?pass_id=" + ids + "&activity_id=" + id + "\",\"timestamp\":\"" + tt + "\",\"type\":\"1\"}", signature1 = AES_Encrypt(signature1), signature1 = encodeURIComponent(signature1), new Promise(_0x1f5331 => {
    ...
    0 && (log("\n【debug】=============== 这是  请求 url =============== "), log(_0x5f8a38)), axios.request(_0x5f8a38).then(async function (_0x4c2510) {
      try {
        0 && (log("\n\n【debug】=============== 这是 返回data ============== "), log(_0x4c2510.data)), data = _0x4c2510.data, data.code == 0 ? (jigsawImageUrls = data.data.block, originalImageUrls = data.data.background, cap_tokens = data.data.token, await slideCompare(jigsawImageUrls, originalImageUrls, cap_tokens)) : log(_0x4c2510.data);
      } catch (_0x3b4b3a) {
...
async function slideCompare(_0x3d40e9, _0x4fe20c, _0x50e592) {
  try {
    ...
    ocr_x = _0xaa3e6b.data.result.target[0], log("ocr返回x轴的值 :", ocr_x), ocr_x = (ocr_x / 384 * 296).toFixed(1), ocr_x = parseInt(ocr_x) + 2;
    const _0x21863a = {
        "x": ocr_x,
        "width": 296,
        "track": [{
    ...
    points = AES_Encrypt(_0xa8ba49), await captcha(points, cap_tokens);
  } catch (_0xcb6495) {
...
async function intelverifcode(_0x18f01c) {
  ts = +new Date(), tt = ts10(), r = randomString(32), n = randomString(6), m = getAASkey(i), d = MD5(t + r + ts + m).toString(), signature = [t, r, ts, d].join(";");
  try {
    let _0x298325 = {
...
async function getrecord11() {
  ...
  try {
    ...
    if (_0x27abd5.code == 0) {
      DoubleLog("账号[" + num + "] 查中奖记录:" + _0x27abd5.msg), recordslist = _0x27abd5.data;
...
var MD5 = function (_0x2611fe) {
  ...
  function _0x5bbf65(_0x5112ea, _0x3265c6) {
    ...
    _0x2c682d = _0x5112ea & 2147483648, _0x1bc9d2 = _0x3265c6 & 2147483648, _0xb3dd3a = _0x5112ea & 1073741824, _0x3375b4 = _0x3265c6 & 1073741824, _0x221fd2 = (_0x5112ea & 1073741823) + (_0x3265c6 & 1073741823);
  ...
  function _0x3821a1(_0x161017) {
    ...
    while (_0x34cb8f < _0x43926d) {
      _0x10b6c7 = (_0x34cb8f - _0x34cb8f % 4) / 4, _0x27ab0e = _0x34cb8f % 4 * 8, _0x58dc16[_0x10b6c7] = _0x58dc16[_0x10b6c7] | _0x161017.charCodeAt(_0x34cb8f) << _0x27ab0e, _0x34cb8f++;
    }
  ...
  function _0x25a11f(_0x281bbd) {
    ...
    for (_0x1d4127 = 0; _0x1d4127 <= 3; _0x1d4127++) {
      try {
        if (_0x105eda.status === 302) {
          ...
          if (_0x105eda.headers["content-type"].includes("text/html")) _0x27b0bc(_0x2a0458);else {
            ...
            if (0) {
              console.log("\n 【debug】=============这是 " + _0x59a5e4 + " json解析后数据============"), console.log(JSON.parse(_0x2a0458));
            }
            _0x27b0bc(_0x2a3432);
          }
        }
      } catch (_0x1171b9) {
        console.log(_0x549305, _0x105eda), console.log("\n " + _0x59a5e4 + " 请求失败！请稍后尝试！"), _0x1458d5(_0x1171b9);
      } finally {}
    }, _0x35e538);
  });
}
async function httpGet(_0xf598ca, _0x4fc184, _0x37811a = 5000) {
  return new Promise((_0x28e60c, _0x5f4d26) => {
    ...
    !_0x4fc184 && (_0x4fc184 = this.constructor.name), 0 && (console.log("\n 【调试】=============== 这是 " + _0x4fc184 + " 请求 url ==============="), console.log(_0x45818b)), $.get(_0x45818b, async (_0x3a7ae3, _0x347b13, _0x472cf0) => {
      try {
        if (_0x347b13.status === 302) {
          ...
          if (_0x347b13.headers["content-type"].includes("text/html")) _0x28e60c(_0x472cf0);else {
            ...
            0 && (console.log("\n 【debug】=============这是 " + _0x4fc184 + " json解析后数据============"), console.log(JSON.parse(_0x472cf0))), _0x28e60c(_0x24084f);
          }
        }
      } catch (_0x305264) {
        console.log(_0x3a7ae3, _0x347b13), console.log("\n " + _0x4fc184 + " 请求失败！请稍后尝试！"), _0x5f4d26(_0x305264);
      } finally {}
    }, _0x37811a);
  });
}
function Env(_0x1da288, _0xf97cc) {
  ...
  return new class {
    constructor(_0x1cf2df, _0x466ad7) {
      this.name = _0x1cf2df, this.http = new _0x2e89a0(this), this.data = null, this.dataFile = "box.dat", this.logs = [], this.isMute = false, this.isNeedRewrite = false, this.logSeparator = "\n", this.startTime = new Date().getTime(), Object.assign(this, _0x466ad7), this.log("", "🔔" + this.name + ", 开始!");
    }
    ["isNode"]() {
    ...
    ["runScript"](_0x3441b1, _0x143020) {
      return new Promise(_0x5b282c => {
        ...
        _0x525163 = _0x525163 ? 1 * _0x525163 : 20, _0x525163 = _0x143020 && _0x143020.timeout ? _0x143020.timeout : _0x525163;
    ...
    ["lodash_get"](_0x3351d6, _0x5444cd, _0x506cad) {
      ...
      for (const _0x185d8e of _0x118fce) if (_0x2152fd = Object(_0x2152fd)[_0x185d8e], undefined === _0x2152fd) return _0x506cad;
      return _0x2152fd;
    }
    ...
    ["setdata"](_0x1478af, _0x97d793) {
      ...
      if (/^@/.test(_0x97d793)) {
        ...
        try {
          ...
          this["lodash_set"](_0x1551d5, _0x52e952, _0x1478af), _0x413486 = this.setval(JSON.stringify(_0x1551d5), _0x144f7d);
        } catch (_0x3d423d) {
          const _0x18761a = {};
          this["lodash_set"](_0x18761a, _0x52e952, _0x1478af), _0x413486 = this.setval(JSON.stringify(_0x18761a), _0x144f7d);
        }
    ...
    ["initGotEnv"](_0x407ecf) {
      this.got = this.got ? this.got : require("got"), this.cktough = this.cktough ? this.cktough : require("tough-cookie"), this.ckjar = this.ckjar ? this.ckjar : new this.cktough.CookieJar(), _0x407ecf && (_0x407ecf.headers = _0x407ecf.headers ? _0x407ecf.headers : {}, undefined === _0x407ecf.headers.Cookie && undefined === _0x407ecf.cookieJar && (_0x407ecf.cookieJar = this.ckjar));
    }
    ["get"](_0x175dbb, _0x38f8c4 = () => {}) {
      _0x175dbb.headers && (delete _0x175dbb.headers["Content-Type"], delete _0x175dbb.headers["Content-Length"]), this.isSurge() || this.isLoon() ? (this.isSurge() && this.isNeedRewrite && (_0x175dbb.headers = _0x175dbb.headers || {}, Object.assign(_0x175dbb.headers, {
        "X-Surge-Skip-Scripting": false
      })), $httpClient.get(_0x175dbb, (_0xa002f9, _0x54805c, _0x5cc9c3) => {
        !_0xa002f9 && _0x54805c && (_0x54805c.body = _0x5cc9c3, _0x54805c.statusCode = _0x54805c.status), _0x38f8c4(_0xa002f9, _0x54805c, _0x5cc9c3);
        ...
        try {
          if (_0x32318b.headers["set-cookie"]) {
            ...
            _0x44b625 && this.ckjar.setCookieSync(_0x44b625, null), _0xa66c95.cookieJar = this.ckjar;
          }
        } catch (_0x40546c) {
    ...
    ["post"](_0x4140cf, _0x51ac0d = () => {}) {
      if (_0x4140cf.body && _0x4140cf.headers && !_0x4140cf.headers["Content-Type"] && (_0x4140cf.headers["Content-Type"] = "application/x-www-form-urlencoded"), _0x4140cf.headers && delete _0x4140cf.headers["Content-Length"], this.isSurge() || this.isLoon()) this.isSurge() && this.isNeedRewrite && (_0x4140cf.headers = _0x4140cf.headers || {}, Object.assign(_0x4140cf.headers, {
        ...
        !_0x5e3f81 && _0x2fd86c && (_0x2fd86c.body = _0x3248dc, _0x2fd86c.statusCode = _0x2fd86c.status), _0x51ac0d(_0x5e3f81, _0x2fd86c, _0x3248dc);
      });else {
    ...
    ["msg"](_0x14b04f = _0x1da288, _0x5d48fb = "", _0x8058d2 = "", _0x4dc078) {
      ...
      if (this.isMute || (this.isSurge() || this.isLoon() ? $notification.post(_0x14b04f, _0x5d48fb, _0x8058d2, _0x8a58e0(_0x4dc078)) : this.isQuanX() && $notify(_0x14b04f, _0x5d48fb, _0x8058d2, _0x8a58e0(_0x4dc078))), !this.isMuteLog) {
        let _0x11998f = ["", "==============📣系统通知📣=============="];
        _0x11998f.push(_0x14b04f), _0x5d48fb && _0x11998f.push(_0x5d48fb), _0x8058d2 && _0x11998f.push(_0x8058d2), console.log(_0x11998f.join("\n")), this.logs = this.logs.concat(_0x11998f);
      }
    }
    ["log"](..._0xd639ca) {
      _0xd639ca.length > 0 && (this.logs = [...this.logs, ..._0xd639ca]), console.log(_0xd639ca.join(this.logSeparator));
    }
    ...
    ["done"](_0x49c1f0 = {}) {
      ...
      this.log("", "🔔" + this.name + ", 结束! 🕛 " + _0x33cd82 + " 秒"), this.log(), (this.isSurge() || this.isQuanX() || this.isLoon()) && $done(_0x49c1f0);
    }
  }(_0x1da288, _0xf97cc);
}
