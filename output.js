...
async function Huaji_0x15b17b() {
  const _0x4e6b8b = function () {
    let _0x1732d5 = true;
    return function (_0x3f7b7a, _0x523ce7) {
      const _0x1059c7 = _0x1732d5 ? function () {
        if (_0x523ce7) {
          const _0xdd66e8 = _0x523ce7.apply(_0x3f7b7a, arguments);
          _0x523ce7 = null;
          return _0xdd66e8;
        }
      } : function () {};
  ...
  const _0xea0015 = _0x4e6b8b(this, function () {
    const _0x4282ed = function () {
      const _0xf3d67d = _0x4282ed.constructor("return /\" + this + \"/")().compile("^([^ ]+( +[^ ]+)+)+[^ ]}");
      return !_0xf3d67d.test(_0xea0015);
    };
    return _0x4282ed();
  });
  _0xea0015();
